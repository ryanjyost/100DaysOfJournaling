      ...
      <Container>
        <Row>
          <Col className="page__column">
            ...
            <p>Last updated: February 15, 2018</p> <br />
            <p>
              Please read these Terms of Service ("Terms", "Terms of Service")
              carefully before using the
              https://www.100daysofjournaling.com/today website (the "Service")
              operated by 100DaysOfJournaling ("us", "we", or "our").
            </p>{" "}
            <br />
            <p>
            ...
            <p>
              ...
              on and through the Service. You agree that this license includes
            ...
            <br />
            <p>
              100DaysOfJournaling has the right but not the obligation to
              monitor and edit all Content provided by users.
            </p>{" "}
            <br />
            <p>
              In addition, Content found on or through this Service are the
              property of 100DaysOfJournaling or used with permission. You may
            ...
            <p>
              ...
              that are not owned or controlled by 100DaysOfJournaling
            </p>{" "}
            <br />
            <p>
              100DaysOfJournaling has no control over, and assumes no
            ...
            <br />
            <p>
              You acknowledge and agree that 100DaysOfJournaling shall not be
            ...
            <p>
              ...
              100DaysOfJournaling and its licensee and licensors, and their
            ...
            <p>
              In no event shall 100DaysOfJournaling, nor its directors,
            ...
            <br />
            <p>
              100DaysOfJournaling its subsidiaries, affiliates, and its
            ...
            <p>
              ...
              laws of Illinois, United States, without regard to its conflict of
              law provisions.
            </p>{" "}
            <br />
            <p>
